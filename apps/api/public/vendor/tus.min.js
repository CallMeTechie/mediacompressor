!(function (t) {
  ...
  return (function n(o, i, u) {
    ...
    for (var s = 'function' == typeof require && require, t = 0; t < u.length; t++) a(u[t]);
    return a;
  })(
    {
      1: [
        function (t, e, r) {
          ...
          var i = n(t('./isReactNative.js')),
            u = n(t('./uriToBlob.js')),
            s = n(t('./sources/FileSource.js')),
            l = n(t('./sources/StreamSource.js'));
          function n(t) {
          ...
          function A() {
                    ...
                    function (t, e) {
                      ...
                      for (u.method = t, u.arg = e; ; ) {
                            ...
                            return o
                              ? o.done
                                ? ((r[e.resultName] = o.value),
                                  (r.next = e.nextLoc),
                                  'return' !== r.method && ((r.method = 'next'), (r.arg = s)),
                                  (r.delegate = null),
                                  g)
                                : o
                              : ((r.method = 'throw'),
                        ...
                        if ('next' === u.method) u.sent = u._sent = u.arg;
                          ...
                          if (a === p) throw ((a = y), u.arg);
                          u.dispatchException(u.arg);
                        } else 'return' === u.method && u.abrupt('return', u.arg);
                        a = d;
                        r = c(o, i, u);
                        if ('normal' === r.type) {
                          if (((a = u.done ? y : h), r.arg === g)) continue;
                          return { value: r.arg, done: u.done };
                        }
                        'throw' === r.type && ((a = y), (u.method = 'throw'), (u.arg = r.arg));
                      }
                    }),
                }),
                e
            ...
            var e = {},
              ...
              w = w && w(w(x([]))),
              _ =
                (w && w !== t && l.call(w, n) && (e = w),
                (b.prototype = v.prototype = Object.create(e)));
            function S(t) {
                    ...
                    return new a(function (t, e) {
                      !(function e(t, r, n, o) {
                        var i,
                          t = c(u[t], u, r);
                        if ('throw' !== t.type)
                          return (r = (i = t.arg).value) && 'object' == P(r) && l.call(r, '__await')
            ...
            return (
              f(_, 'constructor', { value: (m.prototype = b), configurable: !0 }),
              f(b, 'constructor', { value: m, configurable: !0 }),
              (m.displayName = i(b, o, 'GeneratorFunction')),
              ...
              (u.mark = function (t) {
                return (
                  Object.setPrototypeOf
                    ...
                    : ((t.__proto__ = b), i(t, o, 'GeneratorFunction')),
              ...
              (u.AsyncIterator = E),
              (u.async = function (t, e, r, n, o) {
                void 0 === o && (o = Promise);
                var i = new E(a(t, e, r, n), o);
                ...
                finish: function (t) {
                  ...
                  for (var e = this.tryEntries.length - 1; 0 <= e; --e) {
                    var r,
                      ...
                      o = this.tryEntries[e];
                    if (o.tryLoc === t)
                      return 'throw' === (r = o.completion).type && ((n = r.arg), j(o)), n;
                  }
                        ...
                        function (t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                if ((0, i.default)() && e && void 0 !== e.uri)
                                  return (t.prev = 1), (t.next = 4), (0, u.default)(e.uri);
                                t.next = 11;
                                break;
                              case 4:
                                return (n = t.sent), t.abrupt('return', new s.default(n));
                              case 8:
                                throw (
                                  ((t.prev = 8),
                                  (t.t0 = t.catch(1)),
                              ...
                              case 11:
                                if ('function' == typeof e.slice && void 0 !== e.size)
                                  return t.abrupt('return', Promise.resolve(new s.default(e)));
                                t.next = 13;
                                break;
                              case 13:
                                ...
                                if (((r = Number(r)), Number.isFinite(r))) {
                                  t.next = 17;
                                  break;
                                }
                                return t.abrupt(
                              ...
                              case 17:
                                return t.abrupt('return', Promise.resolve(new l.default(e, r)));
                              case 18:
                                return t.abrupt(
                                  'return',
                                  Promise.reject(
        ...
        {
          './isReactNative.js': 5,
          './sources/FileSource.js': 6,
          './sources/StreamSource.js': 7,
          './uriToBlob.js': 10,
        },
      ],
      2: [
                  ...
                  (function (t, e) {
                    var r = t.exif
                      ? (function (t) {
                          ...
                          return e;
                        })(JSON.stringify(t.exif))
                      : 'noexif';
                    return ['tus-rn', t.name || 'noname', t.size || 'nosize', r, e.endpoint].join(
                      '/',
                    );
                  })(t, e),
                );
              return Promise.resolve(
                ['tus-br', t.name, t.type, t.size, t.lastModified, e.endpoint].join('-'),
              );
            });
          var n = (r = t('./isReactNative.js')) && r.__esModule ? r : { default: r };
        },
        { './isReactNative.js': 5 },
      ],
      3: [
              ...
              return (
                u(r, [
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      'upload' in this._xhr &&
                        (this._xhr.upload.onprogress = function (t) {
        ...
        function (t, e, r) {
          ...
          Object.defineProperty(r, '__esModule', { value: !0 }),
            ...
            Object.defineProperty(r, 'enableDebugLog', {
              enumerable: !0,
              get: function () {
                return i.enableDebugLog;
              },
            }),
            (r.isSupported = void 0);
          var n = f(t('../upload.js')),
            o = f(t('../noopUrlStorage.js')),
            i = t('../logger.js'),
            u = f(t('../error.js')),
            a = t('./urlStorage.js'),
            s = f(t('./httpStack.js')),
            l = f(t('./fileReader.js')),
            t = f(t('./fileSignature.js'));
          function f(t) {
            return t && t.__esModule ? t : { default: t };
          }
          function c(t) {
          ...
          function h(t, e, r) {
            e = y(e);
            var n = t,
              e = d() ? Reflect.construct(e, r || [], y(t).constructor) : e.apply(t, r);
          ...
          var w = (r.defaultOptions = m(
            m({}, n.default.defaultOptions),
            {},
            {
              httpStack: new s.default(),
              fileReader: new l.default(),
              urlStorage: new (a.canStoreURLs ? a.WebStorageUrlStorage : o.default)(),
          ...
          (r.Upload = (function (t) {
            ...
            function o() {
              var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null,
                ...
                r = this,
                n = o;
              if (r instanceof n) return h(this, o, [t, m(m({}, w), e)]);
              ...
              (t = [
                {
                  ...
                  value: function (t) {
                    var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                      e = m(m({}, w), e);
                    return n.default.terminate(t, e);
                  },
                },
              ]),
              (e = null) && p(r.prototype, e),
              t && p(r, t),
              Object.defineProperty(r, 'prototype', { writable: !1 }),
              o
            );
            ...
            (r.isSupported =
              ...
              'function' == typeof Blob.prototype.slice);
        },
        {
          '../error.js': 12,
          '../logger.js': 13,
      ...
      6: [
        function (t, e, r) {
          'use strict';
          Object.defineProperty(r, '__esModule', { value: !0 }), (r.default = void 0);
          var o = n(t('./isCordova.js')),
            i = n(t('./readAsByteArray.js'));
          function n(t) {
            return t && t.__esModule ? t : { default: t };
          }
          function u(t) {
              ...
              (r = [
                {
                  ...
                  value: function (t, e) {
                    return (0, o.default)()
                      ? (0, i.default)(this._file.slice(t, e))
                      : ((t = this._file.slice(t, e)),
                        (e = e >= this.size),
      ...
      7: [
        function (t, e, r) {
          ...
          function u(t) {
            return void 0 === t ? 0 : void 0 !== t.size ? t.size : t.length;
          }
          Object.defineProperty(r, '__esModule', { value: !0 }), (r.default = void 0);
          r.default = (function () {
            function e(t) {
              ...
              (r = [
                {
                  ...
                  value: function (t, e) {
                    return t < this._bufferOffset
                      ...
                      : this._readUntilEnoughDataOrDone(t, e);
                  },
                },
                {
                  ...
                  value: function (r, n) {
                    var t,
                      o = this,
                      e = n <= this._bufferOffset + u(this._buffer);
                    return this._done || e
                      ? ((t = null == (e = this._getDataFromBuffer(r, n)) && this._done),
                        Promise.resolve({ value: e, done: t }))
                      : this._reader.read().then(function (t) {
                          var e = t.value;
                          return (
                            t.done
                              ? (o._done = !0)
                              : void 0 === o._buffer
                                ? (o._buffer = e)
                                : (o._buffer = (function (t, e) {
                                    if (t.concat) return t.concat(e);
                                    if (t instanceof Blob)
                                      return new Blob([t, e], { type: t.type });
                                    var r;
                                    if (t.set)
                                      return (
                                        (r = new t.constructor(t.length + e.length)).set(t),
                                        r.set(e, t.length),
                                        r
                                      );
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    var r = 0 === u(this._buffer);
                    return this._done && r ? null : this._buffer.slice(0, e - t);
                  },
                },
                {
                  key: 'close',
      ...
      11: [
        function (t, e, r) {
          ...
          try {
            ...
            localStorage.setItem(u, a), null === a && localStorage.removeItem(u);
          } catch (t) {
            if (t.code !== t.SECURITY_ERR && t.code !== t.QUOTA_EXCEEDED_ERR) throw t;
            n = !1;
          }
          (r.canStoreURLs = n),
            (r.WebStorageUrlStorage = (function () {
              function t() {
                if (!(this instanceof t)) throw new TypeError('Cannot call a class as a function');
              }
              var e, r, n;
              return (
                ...
                (r = [
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      t = this._findEntries('tus::'.concat(t, '::'));
                      return Promise.resolve(t);
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (t, e) {
                      var r = Math.round(1e12 * Math.random()),
                        t = 'tus::'.concat(t, '::').concat(r);
                      return localStorage.setItem(t, JSON.stringify(e)), Promise.resolve(t);
                    },
                  },
                  {
                    key: '_findEntries',
      ...
      12: [
        function (t, e, r) {
          ...
          function s(t, e, r) {
            e = a(e);
            var n = t,
              e = u() ? Reflect.construct(e, r || [], a(t).constructor) : e.apply(t, r);
          ...
          var f = (function (t) {
            ...
            function a(t) {
              ...
              if (i instanceof u)
                return (
                  ((i = s(this, a, [t])).originalRequest = n),
                  (i.originalResponse = o),
                  null != (i.causingError = r) && (t += ', caused by '.concat(r.toString())),
                  null != n &&
                    ...
                    (e = o ? o.getStatus() : 'n/a'),
                    (o = o ? o.getBody() || '' : 'n/a'),
                    (t += ', originated from request (method: '
                      .concat(r, ', url: ')
                      .concat(n, ', response code: ')
                      .concat(e, ', response text: ')
                      .concat(o, ', request id: ')
                      .concat(u, ')'))),
                  (i.message = t),
                  i
      ...
      15: [
        function (t, e, r) {
                    ...
                    return new a(function (t, e) {
                      !(function e(t, r, n, o) {
                        var i,
                          t = c(u[t], u, r);
                        if ('throw' !== t.type)
                          return (r = (i = t.arg).value) && 'object' == A(r) && l.call(r, '__await')
                            ? a.resolve(r.__await).then(
                                function (t) {
                                  e('next', t, n, o);
                                },
                ...
                if (null != r) {
                  ...
                  try {
                    if (((i = (r = r.call(t)).next), 0 === e)) {
                      ...
                      for (
                        ;
                        !(s = (n = i.call(r)).done) && (a.push(n.value), a.length !== e);
                        s = !0
                      );
                  } catch (t) {
                    (l = !0), (o = t);
              ...
              (function (t, e) {
                ...
                if (t)
                  return 'string' == typeof t
                    ...
                    : 'Map' ===
                          (r =
                            'Object' === (r = Object.prototype.toString.call(t).slice(8, -1)) &&
                            t.constructor
                              ? t.constructor.name
                              : r) || 'Set' === r
                      ? Array.from(t)
                        ...
                        .catch(function (t) {
                          ...
                          if (
                            U(
                              (t =
                                t instanceof a.default
                                  ? t
                                  : new a.default('tus: failed to terminate upload', t, u, null)),
                              0,
                              i,
                            )
                          )
                            return (
                              ...
                              (n = h(h({}, i), {}, { retryDelays: r })),
                              new Promise(function (t) {
                                return setTimeout(t, e);
                              }).then(function () {
                                return c.terminate(o, n);
                              })
                            );
                          throw t;
                        });
                ...
                (e = [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var e = this,
                        r = this.file;
                      if (r)
                        if ([g, v].includes(this.options.protocol))
                          if (this.options.endpoint || this.options.uploadUrl || this.url) {
                            var t = this.options.retryDelays;
                            if (null != t && '[object Array]' !== Object.prototype.toString.call(t))
                              this._emitError(
                                new Error(
                              ...
                              if (1 < this.options.parallelUploads)
                                for (
                                  var n = 0,
                                    o = ['uploadUrl', 'uploadSize', 'uploadLengthDeferred'];
                                  n < o.length;
                                  n++
                                ) {
                                  var i = o[n];
                                ...
                                .then(function (t) {
                                  return (
                                    null == t
                                      ...
                                      : (0, u.log)('Calculated fingerprint: '.concat(t)),
                                    (e._fingerprint = t),
                                    e._source ||
                                      e.options.fileReader.openFile(r, e.options.chunkSize)
                                  );
                                })
                                .then(function (t) {
                                  if (((e._source = t), e.options.uploadLengthDeferred))
                                    e._size = null;
                                    ...
                                    if (
                                      ...
                                      return void e._emitError(
                                        new Error(
                                          'tus: cannot convert `uploadSize` option into a number',
                                        ),
                                      );
                                  } else if (((e._size = e._source.size), null == e._size))
                                    return void e._emitError(
                                      new Error(
                                  ...
                                  1 < e.options.parallelUploads || null != e._parallelUploadUrls
                          ...
                          this._emitError(
                            new Error('tus: unsupported protocol '.concat(this.options.protocol)),
                          );
                    ...
                    value: function () {
                      var r,
                        ...
                        t =
                          ...
                          null != this._parallelUploadUrls
                            ...
                            : this.options.parallelUploads),
                        f =
                          null != (e = this.options.parallelUploadBoundaries)
                            ? e
                            : (function (t, e) {
                                for (var r = Math.floor(t / e), n = [], o = 0; o < e; o++)
                                  n.push({ start: r * o, end: r * (o + 1) });
                                return (n[e - 1].end = t), n;
                              })(this._source.size, t),
                        e =
                          (this._parallelUploadUrls &&
                            f.forEach(function (t, e) {
                              t.uploadUrl = a._parallelUploadUrls[e] || null;
                            }),
                          (this._parallelUploadUrls = new Array(f.length)),
                          f.map(function (o, i) {
                            var u = 0;
                            return a._source.slice(o.start, o.end).then(function (t) {
                              var n = t.value;
                              return new Promise(function (t, e) {
                                var t = h(
                                    h({}, a.options),
                                    {},
                                    {
                                      ...
                                      onProgress: function (t) {
                                        (l = l - u + t), (u = t), a._emitProgress(l, s);
                                      },
                                      onUploadUrlAvailable: function () {
                                        (a._parallelUploadUrls[i] = r.url),
                                          a._parallelUploadUrls.filter(function (t) {
                                            return Boolean(t);
                      ...
                      Promise.all(e)
                        .then(function () {
                          ...
                          var t = b(a.options.metadata);
                          return (
                            '' !== t && r.setHeader('Upload-Metadata', t), a._sendRequest(r, null)
                          );
                        })
                        .then(function (t) {
                          var e;
                          w(t.getStatus(), 200)
                            ? null == (e = t.getHeader('Location'))
                              ? a._emitHttpError(r, t, 'tus: invalid or missing Location header')
                              : ((a.url = O(a.options.endpoint, e)),
                                (0, u.log)('Created upload at '.concat(a.url)),
                                a._emitSuccess())
                            : a._emitHttpError(
                                r,
                                t,
                  ...
                  },
                  {
                    ...
                    value: function () {
                      (this._aborted = !1),
                        null != this.url
                          ? ((0, u.log)('Resuming upload from previous URL: '.concat(this.url)),
                            this._resumeUpload())
                          : null != this.options.uploadUrl
                            ? ((0, u.log)(
                              ...
                              this._resumeUpload())
                            : ((0, u.log)('Creating a new upload'), this._createUpload());
                    },
                  },
                  {
                    key: 'abort',
                    value: function (e) {
                      ...
                      return (
                        null != this._parallelUploads &&
                          this._parallelUploads.forEach(function (t) {
                            t.abort(e);
                          }),
                        ...
                        e && null != this.url
                          ? c.terminate(this.url, this.options).then(function () {
                              return t._removeFromUrlStorage();
                            })
                          : Promise.resolve()
                      );
                    },
                  },
                  {
                    ...
                    value: function (t, e, r, n) {
                      this._emitError(new a.default(r, n, t, e));
                    },
                  },
                  {
                    key: '_emitError',
                        ...
                        if (null != this.options.retryDelays)
                          if (
                            (null != this._offset &&
                              ...
                              (this._retryAttempt = 0),
                            U(t, this._retryAttempt, this.options))
                          )
                            return (
                              (e = this.options.retryDelays[this._retryAttempt++]),
                              (this._offsetBeforeRetry = this._offset),
                              void (this._retryTimeout = setTimeout(function () {
                                r.start();
                              }, e))
                            );
                        if ('function' != typeof this.options.onError) throw t;
                  ...
                  },
                  {
                    key: '_emitProgress',
                    value: function (t, e) {
                      'function' == typeof this.options.onProgress && this.options.onProgress(t, e);
                    },
                  },
                  {
                    ...
                    value: function (t, e, r) {
                      'function' == typeof this.options.onChunkComplete &&
                        this.options.onChunkComplete(t, e, r);
                    },
                  },
                  {
                    key: '_createUpload',
                    value: function () {
                      ...
                      this.options.endpoint
                        ? ((r = this._openRequest('POST', this.options.endpoint)),
                          ...
                          '' !== (t = b(this.options.metadata)) &&
                            r.setHeader('Upload-Metadata', t),
                          (this.options.uploadDataDuringCreation &&
                          !this.options.uploadLengthDeferred
                            ? ((this._offset = 0), this._addChunkToRequest(r))
                            : (this.options.protocol === v && r.setHeader('Upload-Complete', '?0'),
                            ...
                            .then(function (t) {
                              ...
                              w(t.getStatus(), 200)
                                ? null == (e = t.getHeader('Location'))
                                  ...
                                  : ((n.url = O(n.options.endpoint, e)),
                                    (0, u.log)('Created upload at '.concat(n.url)),
                            ...
                            .catch(function (t) {
                              n._emitHttpError(r, null, 'tus: failed to create upload', t);
                            }))
                        : this._emitError(
                            new Error(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      this._sendRequest(i, null)
                        .then(function (t) {
                          ...
                          if (!w(e, 200))
                            return 423 === e
                              ...
                              : (w(e, 400) && o._removeFromUrlStorage(),
                                o.options.endpoint
                          ...
                          var r,
                            n = parseInt(t.getHeader('Upload-Offset'), 10);
                          Number.isNaN(n)
                            ? o._emitHttpError(i, t, 'tus: invalid or missing offset value')
                            : ((r = parseInt(t.getHeader('Upload-Length'), 10)),
                              Number.isNaN(r) &&
                              !o.options.uploadLengthDeferred &&
                              o.options.protocol === g
                                ? o._emitHttpError(i, t, 'tus: invalid or missing length value')
                        ...
                        .catch(function (t) {
                          o._emitHttpError(i, null, 'tus: failed to resume upload', t);
                        });
                    },
                  },
                  {
                          ...
                          .catch(function (t) {
                            r._aborted ||
                              r._emitHttpError(
                                e,
                                null,
                                'tus: failed to upload chunk at offset '.concat(r._offset),
                                t,
                              );
                          }));
                    },
                  },
                  {
                    ...
                    value: function (n) {
                      var o = this,
                        e = this._offset,
                        t = this._offset + this.options.chunkSize;
                      return (
                        n.setProgressHandler(function (t) {
                          o._emitProgress(e + t, o._size);
                        }),
                        n.setHeader('Content-Type', 'application/offset+octet-stream'),
                        (t === 1 / 0 || t > this._size) &&
                          !this.options.uploadLengthDeferred &&
                          (t = this._size),
                        this._source.slice(e, t).then(function (t) {
                          var e = t.value,
                            t = t.done,
                            r = e && e.size ? e.size : 0,
                            r =
                              (o.options.uploadLengthDeferred &&
                                t &&
                                ((o._size = o._offset + r), n.setHeader('Upload-Length', o._size)),
                              o._offset + r);
                          return !o.options.uploadLengthDeferred && t && r !== o._size
                            ? Promise.reject(
                                new Error(
                                  'upload was configured with a size of '
                                    .concat(o._size, ' bytes, but the source is done after ')
                                    .concat(r, ' bytes'),
                                ),
                              )
                            : null === e
                              ? o._sendRequest(n)
                              : (o.options.protocol === v &&
                                  n.setHeader('Upload-Complete', t ? '?1' : '?0'),
                                o._emitProgress(o._offset, o._size),
                                o._sendRequest(n, e));
                        })
                      );
                    },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var e = this;
                      this._urlStorageKey &&
                        (this._urlStorage.removeUpload(this._urlStorageKey).catch(function (t) {
                          e._emitError(t);
                        }),
                        (this._urlStorageKey = null));
                    },
                  },
                  {
                    ...
                    value: function () {
                      var t,
                        e = this;
                      return this.options.storeFingerprintForResuming &&
                        this._fingerprint &&
                        ...
                        ? ((t = {
                          ...
                          this._parallelUploads
                            ? (t.parallelUploadUrls = this._parallelUploadUrls)
                            : (t.uploadUrl = this.url),
                          this._urlStorage.addUpload(this._fingerprint, t).then(function (t) {
                            e._urlStorageKey = t;
                          }))
                        : Promise.resolve();
                    },
            ...
            return Object.entries(t)
              .map(function (t) {
                var t = f(t, 2),
                  e = t[0],
                  t = t[1];
                return ''.concat(e, ' ').concat(n.Base64.encode(String(t)));
              })
              .join(',');
          }
          function w(t, e) {
          ...
          function _(t, e, r) {
            var n = r.httpStack.createRequest(t, e),
              t =
                (r.protocol === v
                  ? n.setHeader('Upload-Draft-Interop-Version', '5')
            ...
            return (
              ...
              r.addRequestId && ((e = (0, i.default)()), n.setHeader('X-Request-ID', e)),
              n
            );
          }
          function S() {
          ...
          function E() {
            var a;
            return (
              (a = P().mark(function t(e, r, n) {
                var o;
                return P().wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if ('function' == typeof n.onBeforeRequest)
                          return (t.next = 3), n.onBeforeRequest(e);
                        t.next = 3;
                        break;
                      case 3:
                        return (t.next = 5), e.send(r);
                      case 5:
                        if (((o = t.sent), 'function' == typeof n.onAfterResponse))
                          return (t.next = 9), n.onAfterResponse(e, o);
                        t.next = 9;
                        break;
                      case 9:
          ...
          function U(t, e, r) {
            return (
              !(null == r.retryDelays || e >= r.retryDelays.length || null == t.originalRequest) &&
              (r && 'function' == typeof r.onShouldRetry ? r.onShouldRetry(t, e, r) : j(t))
            );
          }
          function j(t) {
            var t = t.originalResponse ? t.originalResponse.getStatus() : 0;
            return (
              (!w(t, 400) || 409 === t || 423 === t) &&
              ((t = !0), (t = ('undefined' == typeof navigator || !1 !== navigator.onLine) && t))
            );
          }
          function O(t, e) {
            return new o.default(e, t).toString();
          }
          m.defaultOptions = t;
          r.default = m;
        },
              ...
              for (var e, r = t.length, n = r % 3, o = [], i = 0, u = r - n; i < u; i += 16383)
                o.push(
                  (function (t, e, r) {
                    ...
                    return o.join('');
                  })(t, i, u < i + 16383 ? u : i + 16383),
                );
              1 == n
                ? ((e = t[r - 1]), o.push(a[e >> 2] + a[(e << 4) & 63] + '=='))
                : 2 == n &&
                  ((e = (t[r - 2] << 8) + t[r - 1]),
        ...
        function (R, t, L) {
          !function (t) {
            !function () {
                ...
                if ('string' == typeof t) {
                  ...
                  if (c.isEncoding((o = 'string' == typeof o && '' !== o ? o : 'utf8')))
                    return (
                      (i = 0 | p(n, o)),
                      (u = s(i)),
                      (u = (n = u.write(n, o)) !== i ? u.slice(0, n) : u)
                    );
                  ...
                  return (
                    ((i =
                      void 0 === n && void 0 === u
                        ...
                        : void 0 === u
                          ? new Uint8Array(i, n)
                          : new Uint8Array(i, n, u)).__proto__ = c.prototype),
                    i
                  );
                }
                if ('number' == typeof t)
                ...
                var a = (function (t) {
                  {
                    ...
                    if (c.isBuffer(t))
                      return (
                        (e = 0 | f(t.length)), 0 !== (r = s(e)).length && t.copy(r, 0, 0, e), r
                      );
                  }
                  if (void 0 !== t.length)
                    return 'number' != typeof t.length || k(t.length) ? s(0) : l(t);
              ...
              function u(t) {
                return o(t), s(t < 0 ? 0 : 0 | f(t));
              }
              function l(t) {
                for (var e = t.length < 0 ? 0 : 0 | f(t.length), r = s(e), n = 0; n < e; n += 1)
                  r[n] = 255 & t[n];
                return r;
              }
              function f(t) {
                ...
                for (t = t || 'utf8'; ; )
                  switch (t) {
                    ...
                    case 'binary':
                      ...
                      for (var m = u; m < g; ++m) v += String.fromCharCode(y[m]);
                      return v;
                    case 'base64':
                      return (
                        (b = this),
                    ...
                    case 'utf-16le':
                      for (
                        var b = e, w = r, _ = this.slice(b, w), S = '', E = 0;
                        E < _.length;
                        E += 2
                      )
                        S += String.fromCharCode(_[E] + 256 * _[E + 1]);
                      return S;
                    default:
              ...
              function h(t, e, r, n, o) {
                ...
                if (
                  ...
                  (r = (r = k((r = +r)) ? (o ? 0 : t.length - 1) : r) < 0 ? t.length + r : r) >=
                    t.length)
                ) {
                  if (o) return -1;
                  r = t.length - 1;
                ...
                if (('string' == typeof e && (e = c.from(e, n)), c.isBuffer(e)))
                  return 0 === e.length ? -1 : d(t, e, r, n, o);
                if ('number' == typeof e)
                  return (
                    (e &= 255),
                ...
                return P(
                  (function (t, e) {
                    for (var r, n, o = [], i = 0; i < t.length && !((e -= 2) < 0); ++i)
                      (r = t.charCodeAt(i)), (n = r >> 8), o.push(r % 256), o.push(n);
                    return o;
                  })(e, t.length - r),
                  t,
                  r,
              ...
              function j(t, e, r) {
                ...
                for (var n = [], o = e; o < r; ) {
                  ...
                  null === f
                    ? ((f = 65533), (c = 1))
                    : 65535 < f &&
                      (n.push((((f -= 65536) >>> 10) & 1023) | 55296), (f = 56320 | (1023 & f))),
                    n.push(f),
                    (o += c);
                }
                var p = n,
                  h = p.length;
                if (h <= m) return String.fromCharCode.apply(String, p);
                for (var d = '', y = 0; y < h; )
                  d += String.fromCharCode.apply(String, p.slice(y, (y += m)));
                return d;
              }
              (L.kMaxLength = e),
                ...
                (c.concat = function (t, e) {
                  ...
                  for (var r = c.allocUnsafe(e), n = 0, o = 0; o < t.length; ++o) {
                    var i = t[o];
                    if ((A(i, Uint8Array) && (i = c.from(i)), !c.isBuffer(i)))
                      throw new TypeError('"list" argument must be an Array of Buffers');
                ...
                (c.prototype.compare = function (t, e, r, n, o) {
                  if ((A(t, Uint8Array) && (t = c.from(t, t.offset, t.byteLength)), !c.isBuffer(t)))
                    throw new TypeError(
                ...
                (c.prototype.write = function (t, e, r, n) {
                  ...
                  for (var i, u, a, s = !1; ; )
                    switch (n) {
                      ...
                      case 'utf8':
                      case 'utf-8':
                        return (h = e), (a = r), P(O(t, (u = this).length - h), u, h, a);
                      case 'ascii':
                        return g(this, t, e, r);
                      case 'latin1':
                      case 'binary':
                        return g(this, t, e, r);
                      case 'base64':
                        return (u = this), (a = e), (i = r), P(x(t), u, a, i);
                      case 'ucs2':
                      case 'ucs-2':
                      case 'utf16le':
                      case 'utf-16le':
              ...
              function _(t, e, r, n, o) {
                return (e = +e), (r >>>= 0), o || w(t, 0, r, 4), i.write(t, e, r, n, 23, 4), r + 4;
              }
              function S(t, e, r, n, o) {
                return (e = +e), (r >>>= 0), o || w(t, 0, r, 8), i.write(t, e, r, n, 52, 8), r + 8;
              }
              (c.prototype.slice = function (t, e) {
                ...
                (c.prototype.readUInt8 = function (t, e) {
                  return (t >>>= 0), e || y(t, 1, this.length), this[t];
                }),
                (c.prototype.readUInt16LE = function (t, e) {
                  return (t >>>= 0), e || y(t, 2, this.length), this[t] | (this[t + 1] << 8);
                }),
                (c.prototype.readUInt16BE = function (t, e) {
                  return (t >>>= 0), e || y(t, 2, this.length), (this[t] << 8) | this[t + 1];
                }),
                ...
                (c.prototype.readIntLE = function (t, e, r) {
                  (t >>>= 0), (e >>>= 0), r || y(t, e, this.length);
                  for (var n = this[t], o = 1, i = 0; ++i < e && (o *= 256); ) n += this[t + i] * o;
                  return (o *= 128) <= n && (n -= Math.pow(2, 8 * e)), n;
                }),
                ...
                (c.prototype.readFloatLE = function (t, e) {
                  return (t >>>= 0), e || y(t, 4, this.length), i.read(this, t, !0, 23, 4);
                }),
                (c.prototype.readFloatBE = function (t, e) {
                  return (t >>>= 0), e || y(t, 4, this.length), i.read(this, t, !1, 23, 4);
                }),
                (c.prototype.readDoubleLE = function (t, e) {
                  return (t >>>= 0), e || y(t, 8, this.length), i.read(this, t, !0, 52, 8);
                }),
                (c.prototype.readDoubleBE = function (t, e) {
                  return (t >>>= 0), e || y(t, 8, this.length), i.read(this, t, !1, 52, 8);
                }),
                ...
                (c.prototype.writeUInt8 = function (t, e, r) {
                  return (
                    (t = +t), (e >>>= 0), r || b(this, t, e, 1, 255, 0), (this[e] = 255 & t), e + 1
                  );
                }),
                ...
                (c.prototype.writeIntLE = function (t, e, r, n) {
                  (t = +t), (e >>>= 0), n || b(this, t, e, r, (n = Math.pow(2, 8 * r - 1)) - 1, -n);
                  var o = 0,
                    i = 1,
                    u = 0;
                ...
                (c.prototype.copy = function (t, e, r, n) {
                  ...
                  if (this === t && 'function' == typeof Uint8Array.prototype.copyWithin)
                    ...
                    for (var i = o - 1; 0 <= i; --i) t[i + e] = this[i + r];
                ...
                (c.prototype.fill = function (t, e, r, n) {
                  if ('string' == typeof t) {
                    ...
                    var o;
                    1 === t.length &&
                      ((o = t.charCodeAt(0)), ('utf8' === n && o < 128) || 'latin1' === n) &&
                      (t = o);
        ...
        function (t, e, r) {
          (r.read = function (t, e, r, n, o) {
            ...
            for (
              ...
              0 < f;
              i = 256 * i + t[e + c], c += p, f -= 8
            );
            for (
              u = i & ((1 << -f) - 1), i >>= -f, f += n;
              0 < f;
              u = 256 * u + t[e + c], c += p, f -= 8
            );
            if (0 === i) i = 1 - l;
            else {
                ...
                e = Math.abs(e),
                  isNaN(e) || e === 1 / 0
                    ...
                    : ((u = Math.floor(Math.log(e) / Math.LN2)),
                      ...
                      2 <= (e += 1 <= u + f ? c / n : c * Math.pow(2, 1 - f)) * n &&
                        (u++, (n /= 2)),
                      l <= u + f
                        ? ((a = 0), (u = l))
                        : 1 <= u + f
                          ? ((a = (e * n - 1) * Math.pow(2, o)), (u += f))
                          : ((a = e * Math.pow(2, f - 1) * Math.pow(2, o)), (u = 0)));
                8 <= o;
                t[r + p] = 255 & a, p += h, a /= 256, o -= 8
              );
              for (u = (u << o) | a, s += o; 0 < s; t[r + p] = 255 & u, p += h, u /= 256, s -= 8);
              t[r + p - h] |= 128 * i;
            });
        },
        {},
            ...
            !function () {
              ...
              (t =
                ...
                (e = function () {
                  ...
                  function t(t) {
                    for (var e, r, n, o = '', i = t.length % 3, u = 0; u < t.length; ) {
                      if (
                        255 < (e = t.charCodeAt(u++)) ||
                        255 < (r = t.charCodeAt(u++)) ||
                        255 < (n = t.charCodeAt(u++))
                      )
                        throw new TypeError('invalid character found');
                      o +=
                        w[((e = (e << 16) | (r << 8) | n) >> 18) & 63] +
                        w[(e >> 12) & 63] +
                        w[(e >> 6) & 63] +
                        w[63 & e];
                    }
                  ...
                  function e(t, e) {
                    return (e = void 0 === e ? !1 : e) ? r(x(t)) : x(t);
                  }
                  function n(t) {
                    var e;
                    return t.length < 2
                      ? (e = t.charCodeAt(0)) < 128
                        ? t
                        : e < 2048
                          ? E(192 | (e >>> 6)) + E(128 | (63 & e))
                          : E(224 | ((e >>> 12) & 15)) +
                            E(128 | ((e >>> 6) & 63)) +
                            E(128 | (63 & e))
                  ...
                  function i(t, e) {
                    return (e = void 0 === e ? !1 : e) ? r(A(t)) : A(t);
                  }
                  function u(t) {
                    return i(t, !0);
                  }
                  ...
                  function d() {
                    function t(t, e) {
                      Object.defineProperty(String.prototype, t, h(e));
                    }
                  ...
                  function y() {
                    function t(t, e) {
                      Object.defineProperty(Uint8Array.prototype, t, h(e));
                    }
                    t('toBase64', function (t) {
                      return e(this, t);
                    }),
                  ...
                  var g,
                    v = 'function' == typeof T,
                    m = 'function' == typeof TextDecoder ? new TextDecoder() : void 0,
                    ...
                    O =
                      'function' == typeof btoa
                        ...
                        : v
                          ? function (t) {
                              return T.from(t, 'binary').toString('base64');
                            }
                          : t,
                    x = v
                      ? function (t) {
                          return T.from(t).toString('base64');
                        }
                      : function (t) {
                          for (var e = [], r = 0, n = t.length; r < n; r += 4096)
                            e.push(E.apply(null, t.subarray(r, r + 4096)));
                          return O(e.join(''));
                        },
                    P = /[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,
                    A = v
                      ? function (t) {
                          return T.from(t, 'utf8').toString('base64');
                        }
                      : b
                        ? function (t) {
                            return x(b.encode(t));
                    ...
                    R =
                      'function' == typeof atob
                        ...
                        : v
                          ? function (t) {
                              return T.from(t, 'base64').toString('binary');
                            }
                          : l,
                    L = v
                      ? function (t) {
                          return U(T.from(t, 'base64'));
                        }
                      : function (t) {
                          return U(
                            R(t)
                    ...
                    B = v
                      ? function (t) {
                          return T.from(t, 'base64').toString('utf8');
                        }
                      : m
                        ? function (t) {
                            return m.decode(L(t));
        ...
        function (t, e, r) {
          ...
          (r.stringify = function (t, e) {
            var r,
              n,
              o = [];
            for (n in ('string' != typeof (e = e || '') && (e = '?'), t))
              i.call(t, n) &&
                ((r = t[n]) || (null != r && !isNaN(r)) || (r = ''),
                (n = a(n)),
                (r = a(r)),
                null !== n) &&
                null !== r &&
          ...
          !function (u) {
            !function () {
              ...
              var v = [
                  ...
                  ['?', 'query'],
                  function (t, e) {
                    return b(e.protocol) ? t.replace(/\\/g, '/') : t;
                  },
                  ['/', 'pathname'],
                  ['@', 'auth', 1],
                  [NaN, 'host', void 0, 1, 1],
              ...
              function m(t) {
                var e,
                  ...
                  n = {},
                  r = typeof (t = t || r);
                if ('blob:' === t.protocol) n = new _(unescape(t.pathname), {});
                else if ('string' == r) for (e in ((n = new _(t, {})), i)) delete n[e];
                else if ('object' == r) {
                  for (e in t) e in i || (n[e] = t[e]);
              ...
              function w(t, e) {
                ...
                return (
                  o
                    ? (u = i
                        ? ((r = t[2] + t[3] + t[4]), t[2].length + t[3].length)
                        : ((r = t[2] + t[4]), t[2].length))
                    : i
                      ? ((r = t[3] + t[4]), (u = t[3].length))
                      : (r = t[4]),
                  'file:' === n
                    ? 2 <= u && (r = r.slice(2))
                    : b(n)
                      ...
                      : n
                        ? o && (r = r.slice(2))
                        : 2 <= u && b(e.protocol) && (r = t[4]),
                  { protocol: n, slashes: o || b(n), slashesCount: u, rest: r }
                );
              }
              function _(t, e, r) {
                if (((t = (t = g(t)).replace(d, '')), !(this instanceof _))) return new _(t, e, r);
                var n,
                  o,
                  i,
                  u,
                  ...
                  c = 0;
                for (
                  'object' != l && 'string' != l && ((r = e), (e = null)),
                    r && 'function' != typeof r && (r = h.parse),
                    n = !(l = w(t || '', (e = m(e)))).protocol && !l.slashes,
                    f.slashes = l.slashes || (n && e.slashes),
                    f.protocol = l.protocol || e.protocol || '',
                    t = l.rest,
                    (('file:' === l.protocol && (2 !== l.slashesCount || y.test(t))) ||
                      (!l.slashes && (l.protocol || l.slashesCount < 2 || !b(f.protocol)))) &&
                      (s[3] = [/(.*)/, 'pathname']);
                  c < s.length;
                  c++
                )
                  'function' == typeof (i = s[c])
                    ...
                    : ((o = i[0]),
                      ...
                      o != o
                        ? (f[a] = t)
                        : 'string' == typeof o
                          ? ~(u = '@' === o ? t.lastIndexOf(o) : t.indexOf(o)) &&
                            (t =
                              'number' == typeof i[2]
                                ? ((f[a] = t.slice(0, u)), t.slice(u + i[2]))
                                : ((f[a] = t.slice(u)), t.slice(0, u)))
                          : (u = o.exec(t)) && ((f[a] = u[1]), (t = t.slice(0, u.index))),
                      (f[a] = f[a] || (n && i[3] && e[a]) || ''),
                ...
                r && (f.query = r(f.query)),
                  n &&
                    ...
                    (f.pathname = (function (t, e) {
                      if ('' === t) return e;
                      for (
                        var r = (e || '/').split('/').slice(0, -1).concat(t.split('/')),
                          n = r.length,
                          e = r[n - 1],
                          o = !1,
                          i = 0;
                  ...
                  (f.origin =
                    'file:' !== f.protocol && b(f.protocol) && f.host
                      ? f.protocol + '//' + f.host
                      : 'null'),
                  (f.href = f.toString());
              }
              (_.prototype = {
                set: function (t, e, r) {
                  ...
                  switch (t) {
                    case 'query':
                      'string' == typeof e && e.length && (e = (r || h.parse)(e)), (n[t] = e);
                      break;
                    case 'port':
                      (n[t] = e),
                        p(e, n.protocol)
                    ...
                    case 'host':
                      (n[t] = e),
                        a.test(e)
                          ? ((e = e.split(':')), (n.port = e.pop()), (n.hostname = e.join(':')))
                          : ((n.hostname = e), (n.port = ''));
                      break;
                    case 'protocol':
                  ...
                  return (
                    ...
                    (n.origin =
                      'file:' !== n.protocol && b(n.protocol) && n.host
                        ? n.protocol + '//' + n.host
                        : 'null'),
                    (n.href = n.toString()),
                    n
                ...
                toString: function (t) {
                  ...
                  var e = this,
                    r = e.host,
                    n =
                      ((n = e.protocol) && ':' !== n.charAt(n.length - 1) && (n += ':'),
                      n + ((e.protocol && e.slashes) || b(e.protocol) ? '//' : ''));
                  return (
                    e.username
                      ...
                      : e.password
                        ...
                        : 'file:' !== e.protocol &&
                          ...
                          '/' !== e.pathname &&
                          (n += '@'),
                    (':' === r[r.length - 1] || (a.test(e.hostname) && !e.port)) && (r += ':'),
                    (n += r + e.pathname),
                    (r = 'object' == typeof e.query ? t(e.query) : e.query) &&
                      (n += '?' !== r.charAt(0) ? '?' + r : r),
                    e.hash && (n += e.hash),
                    n
                  );
